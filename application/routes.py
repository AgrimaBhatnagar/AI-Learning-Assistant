...
@api.route('/subjects/<int:subject_id>/weeks/<int:week_number>/lectures/<int:lecture_id>', methods=['GET', 'PUT', 'DELETE'])
...
def week_assignments(subject_id, week_number):
    ...
    if request.method == 'GET':
        assignments = Assignment.query.filter_by(subject_id=subject_id, week_number=week_number).all()
...
@api.route('/subjects/<int:subject_id>/weeks/<int:week_number>/assignments/<int:assignment_id>', methods=['GET', 'PUT', 'DELETE'])
def specific_assignment(subject_id, week_number, assignment_id):
    ...
    assignment = Assignment.query.filter_by(id=assignment_id, subject_id=subject_id, week_number=week_number).first_or_404()
...
@api.route('/subjects/<int:subject_id>/weeks/<int:week_number>/assignments/<int:assignment_id>/questions/<int:question_id>', methods=['PUT', 'DELETE'])
